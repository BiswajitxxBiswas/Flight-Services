...
async function getFlight(id) {
    try {
        ...
        throw new AppError('Can not Fetch data of Flight',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateSeats(data){
    try {
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND){
            throw new AppError("The flight you request to update is not present",error.statusCode);
        }
        throw new AppError('Can not Update Flight',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
